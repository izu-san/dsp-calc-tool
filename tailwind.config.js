...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'grid-pattern': 'linear-gradient(to right, rgba(0, 136, 255, 0.1) 1px, transparent 1px), linear-gradient(to bottom, rgba(0, 136, 255, 0.1) 1px, transparent 1px)',
        'energy-glow': 'radial-gradient(circle at center, rgba(0, 136, 255, 0.15), transparent 70%)',
        'space-gradient': 'linear-gradient(135deg, #0d1117 0%, #192746 50%, #0d1117 100%)',
        'nebula-gradient': 'radial-gradient(ellipse at top, rgba(168, 85, 247, 0.15), transparent 50%), radial-gradient(ellipse at bottom, rgba(0, 136, 255, 0.15), transparent 50%)',
      },
      boxShadow: {
        ...
        'energy': '0 0 15px rgba(0, 136, 255, 0.4), 0 0 30px rgba(0, 136, 255, 0.2), inset 0 0 10px rgba(0, 136, 255, 0.1)',
      ...
      keyframes: {
        glow: {
          ...
          '100%': { 
            boxShadow: '0 0 10px rgba(0, 136, 255, 0.8), 0 0 20px rgba(0, 136, 255, 0.5), 0 0 30px rgba(0, 136, 255, 0.3)',
          },
        },
        scan: {
          '0%': { 
