...
import type { Item, RecipeItem, Recipe, Machine, GameData } from "../game-data";
  ...
  describe("Recipe", () => {
    it("should have all recipe properties", () => {
      const recipe: Recipe = {
        ...
        Explicit: true,
        TimeSpend: 60,
        Items: [{ id: 1001, name: "Iron Ore", count: 1, Type: "Ore", isRaw: true }],
        Results: [{ id: 1101, name: "Iron Ingot", count: 1, Type: "Ingot", isRaw: false }],
        GridIndex: "1101",
        productive: true,
      };
    ...
    it("should handle different recipe types", () => {
      const assembleRecipe: Recipe = {
        ...
        Explicit: false,
        TimeSpend: 120,
        Items: [{ id: 1101, name: "Iron Ingot", count: 1, Type: "Ingot", isRaw: false }],
        Results: [{ id: 1201, name: "Iron Gear", count: 1, Type: "Component", isRaw: false }],
        GridIndex: "1201",
        productive: true,
      };
