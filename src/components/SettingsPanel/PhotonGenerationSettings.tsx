...
export function PhotonGenerationSettings() {
  ...
  const currentEfficiency = calculateRayTransmissionEfficiency(
    photonGeneration.rayTransmissionEfficiency
  );
    ...
    <div className="space-y-4" data-testid="photon-generation-settings-section">
      ...
      <div className="space-y-2">
        <label className="text-sm font-medium block">
          {t("rayTransmissionEfficiency")}: {t("researchLevel")}{" "}
          {photonGeneration.rayTransmissionEfficiency}
        </label>
        <input
          type="range"
          ...
          onChange={e =>
            setPhotonGenerationSetting("rayTransmissionEfficiency", Number(e.target.value))
          }
        ...
        <div className="flex justify-between text-xs text-space-300 mt-1">
          ...
          <span>
            100% <span className="text-gray-500">(Lv: {maxResearchLevel})</span>
          </span>
        </div>
      </div>
