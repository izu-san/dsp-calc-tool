        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          >
            ...
            <div className="text-2xl font-bold text-neon-blue">
              {formatBuildingCount(enhancedStatistics.totalMachines)}
            </div>
            {enhancedStatistics.totalMiningMachines > 0 && (
              <div className="text-xs text-neon-blue mt-1">
                ⛏️ {t("miningMachines")}:{" "}
                {formatBuildingCount(enhancedStatistics.totalMiningMachines)}
              </div>
            )}
          </div>
          <div
          ...
          >
            ...
            {enhancedStatistics.totalOrbitalCollectors > 0 && (
              <div className="text-xs text-neon-yellow mt-1">
                🚀 {t("orbitalCollectors")}:{" "}
                {formatBuildingCount(enhancedStatistics.totalOrbitalCollectors)}
              </div>
            )}
          </div>
          <div
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-neon-green/20 border-b-2 border-neon-green/50">
                <tr>
                  <th className="px-4 py-2 text-left text-sm font-medium text-neon-green">
                    {t("item")}
                  </th>
                  <th className="px-4 py-2 text-right text-sm font-medium text-neon-green">
                    {t("requiredRate")}
                  </th>
                </tr>
              </thead>
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-neon-cyan/20 border-b-2 border-neon-cyan/50">
                <tr>
                  <th className="px-4 py-2 text-left text-sm font-medium text-neon-cyan">
                    {t("item")}
                  </th>
                  <th className="px-4 py-2 text-right text-sm font-medium text-neon-cyan">
                    {t("production")}
                  </th>
                  <th className="px-4 py-2 text-right text-sm font-medium text-neon-cyan">
                    {t("consumption")}
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-neon-purple/20 border-b-2 border-neon-purple/50">
                <tr>
                  <th className="px-4 py-2 text-left text-sm font-medium text-neon-purple">
                    {t("item")}
                  </th>
                  <th className="px-4 py-2 text-right text-sm font-medium text-neon-purple">
                    {t("productionRate")}
                  </th>
                </tr>
              </thead>
