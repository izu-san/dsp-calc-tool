...
describe("AlternativeRecipeSelector", () => {
  ...
  it("対象アイテムが無い場合は noAlternativeRecipesFound を表示", () => {
    ...
    selectionMock = {
      ...
      calculationResult: {
        rootNode: {
          recipe: { Items: [{ id: 999, name: "X", count: 1 }], Results: [], TimeSpend: 60 },
          children: [],
        },
      },
    };
  ...
  it("代替レシピがあるアイテムの展開と選択ができる", () => {
    ...
    selectionMock = {
      ...
      calculationResult: {
        rootNode: {
          recipe: { Items: [{ id: 100, name: "Item100", count: 1 }], Results: [], TimeSpend: 60 },
          children: [],
        },
      },
    };
  ...
  it("採掘可能アイテム(200)では mining オプションが表示され選択できる", () => {
    const recipeC = {
      ...
      name: "RecipeC",
      Items: [],
      Results: [{ id: 200, name: "Item200", count: 1 }],
      TimeSpend: 60,
      Type: "Assemble",
    };
    gameDataMock = {
    ...
    selectionMock = {
      ...
      calculationResult: {
        rootNode: {
          recipe: { Items: [{ id: 200, name: "Item200", count: 1 }], Results: [], TimeSpend: 60 },
          children: [],
        },
      },
    };
  ...
  it("比較ボタンで比較モーダルを開き、モーダルから選択できる", () => {
    const recipeA = {
      ...
      name: "RecipeA",
      Items: [],
      Results: [{ id: 300, name: "Item300", count: 1 }],
      TimeSpend: 60,
      Type: "Assemble",
    };
    const recipeB = {
    ...
    selectionMock = {
      ...
      calculationResult: {
        rootNode: {
          recipe: { Items: [{ id: 300, name: "Item300", count: 1 }], Results: [], TimeSpend: 60 },
          children: [],
        },
      },
    };
