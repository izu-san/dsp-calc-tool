      ...
      >
        ...
        <div className="sticky top-0 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            {node.recipe && <ItemIcon itemId={node.recipe.Results[0]?.id} size={32} />}
            <div>
              ...
              <div>
                ...
                {proliferatorType !== "none" && (
                  <div>
                    ...
                    {!isProductionAllowed && (
                      <div
                        className="mb-3 p-2 bg-orange-100 dark:bg-orange-900/20 border border-orange-300 dark:border-orange-700 rounded-lg"
                        role="alert"
                      >
                        <div className="flex items-center gap-2 text-sm text-orange-800 dark:text-orange-300 font-medium">
                          <span className="text-lg">⚠️</span>
                          <span>{t("productionModeDisabled")}</span>
                        </div>
                        <div className="text-xs text-orange-700 dark:text-orange-400 mt-1 ml-6">
