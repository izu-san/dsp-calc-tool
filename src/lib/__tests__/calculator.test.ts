...
describe('calculateConveyorBelts', () => {
  it('should calculate required belts for given throughput', () => {
    ...
    const inputs = [
      { itemId: 1, itemName: 'Iron Ore', requiredRate: 30 },
    ];
  ...
  it('should calculate saturation percentage', () => {
    ...
    const inputs = [
      { itemId: 1, itemName: 'Iron Ore', requiredRate: 18 },
    ];
...
describe('buildRecipeTree', () => {
  ...
  const createMockGameData = (): GameData => {
    ...
    items.set(1001, { id: 1001, name: 'Iron Ore', Type: '0', isRaw: true, miningFrom: 'Iron Vein' });
    items.set(1105, { id: 1105, name: 'Copper Ingot', Type: '0', isRaw: false });
    items.set(1002, { id: 1002, name: 'Copper Ore', Type: '0', isRaw: true, miningFrom: 'Copper Vein' });
    ...
    return {
      ...
      items,
      allItems: items,
      recipesByItemId: new Map([[1104, [recipes.get(1)!]], [1105, [recipes.get(2)!]]]),
    };
  };
  ...
  it('should calculate conveyor belts', () => {
    ...
    expect(tree.conveyorBelts.total).toBe(
      tree.conveyorBelts.inputs + tree.conveyorBelts.outputs
    );
  });
  ...
  it('should generate unique node IDs based on path', () => {
    ...
    const tree = buildRecipeTree(recipe, 1, gameData, settings, nodeOverrides, 0, 20, 'custom-path');
  ...
  it('should apply machineRank override for Assemble type (mk1, mk2, mk3)', () => {
    ...
    const tree1 = buildRecipeTree(assembleRecipe, 1, gameData, settings, nodeOverrides, 0, 20, 'r-2-mk1');
    ...
    const tree2 = buildRecipeTree(assembleRecipe, 1, gameData, settings, nodeOverrides, 0, 20, 'r-2-mk2');
    ...
    const tree3 = buildRecipeTree(assembleRecipe, 1, gameData, settings, nodeOverrides, 0, 20, 'r-2-mk3');
  ...
  it('should apply machineRank override for Chemical type', () => {
    ...
    const tree1 = buildRecipeTree(chemicalRecipe, 1, gameData, settings, nodeOverrides, 0, 20, 'r-3-std');
    expect(tree1.machine).toBeDefined();
    ...
    const tree2 = buildRecipeTree(chemicalRecipe, 1, gameData, settings, nodeOverrides, 0, 20, 'r-3-quantum');
    expect(tree2.machine).toBeDefined();
  ...
  it('should apply machineRank override for Research type', () => {
    ...
    const tree1 = buildRecipeTree(researchRecipe, 1, gameData, settings, nodeOverrides, 0, 20, 'r-4-std');
    expect(tree1.machine).toBeDefined();
  ...
  it('should apply machineRank override for Smelt type (negentropy)', () => {
    ...
    const tree = buildRecipeTree(smeltRecipe, 1, gameData, settings, nodeOverrides, 0, 20, 'r-1-negentropy');
    expect(tree.machine).toBeDefined();
  ...
  it('should apply machineRank override for Assemble type (recomposing)', () => {
    ...
    const tree = buildRecipeTree(assembleRecipe, 1, gameData, settings, nodeOverrides, 0, 20, 'r-2-recomp');
    expect(tree.machine).toBeDefined();
  ...
  it('should apply machineRank override for Chemical type (quantum)', () => {
    ...
    const tree = buildRecipeTree(chemicalRecipe, 1, gameData, settings, nodeOverrides, 0, 20, 'r-3-quantum');
    expect(tree.machine).toBeDefined();
  ...
  it('should apply machineRank override for Research type (self-evolution)', () => {
    ...
    const tree = buildRecipeTree(researchRecipe, 1, gameData, settings, nodeOverrides, 0, 20, 'r-4-selfevo');
    expect(tree.machine).toBeDefined();
...
describe('calculateProductionChain', () => {
  ...
  it('should calculate total power consumption across tree', () => {
    ...
    expect(result.totalPower.total).toBe(
      result.totalPower.machines + result.totalPower.sorters
    );
  });
