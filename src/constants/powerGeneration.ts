...
import type { PowerGeneratorInfo, PowerGeneratorType, FuelItem } from "@/types/power-generation";
 ...
 * テンプレート別の使用可能な発電設備
 */
export const TEMPLATE_POWER_GENERATORS: Record<string, PowerGeneratorType[]> = {
  // デフォルト（初期状態）: 終盤と同じ設備
  default: [
    "windTurbine",
    "thermalPlant",
  ...
  lateGame: ["windTurbine", "thermalPlant", "geothermal", "solarPanel", "miniFusion"],
  endGame: [
    "windTurbine",
    "thermalPlant",
    "geothermal",
...
export const TEMPLATE_FUELS: Record<string, string[]> = {
  ...
  earlyGame: ["coal", "crudeOil", "refinedOil", "energeticGraphite", "hydrogen", "combustibleUnit"],
  midGame: [
    "coal",
    "crudeOil",
    "refinedOil",
