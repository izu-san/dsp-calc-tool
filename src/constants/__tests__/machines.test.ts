...
describe('machines', () => {
  ...
  const mockMachines = new Map<number, Machine>([
    // Smelt machines
    [2302, { id: 2302, name: 'Arc Smelter', Type: 'Smelt', count: 0, isRaw: false, assemblerSpeed: 1, workEnergyPerTick: 360, idleEnergyPerTick: 12, exchangeEnergyPerTick: 0, isPowerConsumer: true, isPowerExchanger: false }],
    [2315, { id: 2315, name: 'Plane Smelter', Type: 'Smelt', count: 0, isRaw: false, assemblerSpeed: 2, workEnergyPerTick: 720, idleEnergyPerTick: 24, exchangeEnergyPerTick: 0, isPowerConsumer: true, isPowerExchanger: false }],
    [2319, { id: 2319, name: 'Negentropy Smelter', Type: 'Smelt', count: 0, isRaw: false, assemblerSpeed: 3, workEnergyPerTick: 1080, idleEnergyPerTick: 36, exchangeEnergyPerTick: 0, isPowerConsumer: true, isPowerExchanger: false }],
    
    // Assemble machines
    [2303, { id: 2303, name: 'Assembling Machine Mk.I', Type: 'Assemble', count: 0, isRaw: false, assemblerSpeed: 0.75, workEnergyPerTick: 270, idleEnergyPerTick: 9, exchangeEnergyPerTick: 0, isPowerConsumer: true, isPowerExchanger: false }],
    [2304, { id: 2304, name: 'Assembling Machine Mk.II', Type: 'Assemble', count: 0, isRaw: false, assemblerSpeed: 1, workEnergyPerTick: 360, idleEnergyPerTick: 12, exchangeEnergyPerTick: 0, isPowerConsumer: true, isPowerExchanger: false }],
    [2305, { id: 2305, name: 'Assembling Machine Mk.III', Type: 'Assemble', count: 0, isRaw: false, assemblerSpeed: 1.5, workEnergyPerTick: 540, idleEnergyPerTick: 18, exchangeEnergyPerTick: 0, isPowerConsumer: true, isPowerExchanger: false }],
    [2318, { id: 2318, name: 'Re-composing Assembler', Type: 'Assemble', count: 0, isRaw: false, assemblerSpeed: 3, workEnergyPerTick: 1080, idleEnergyPerTick: 36, exchangeEnergyPerTick: 0, isPowerConsumer: true, isPowerExchanger: false }],
    
    // Chemical machines
    [2309, { id: 2309, name: 'Chemical Plant', Type: 'Chemical', count: 0, isRaw: false, assemblerSpeed: 1, workEnergyPerTick: 360, idleEnergyPerTick: 12, exchangeEnergyPerTick: 0, isPowerConsumer: true, isPowerExchanger: false }],
    [2317, { id: 2317, name: 'Quantum Chemical Plant', Type: 'Chemical', count: 0, isRaw: false, assemblerSpeed: 2, workEnergyPerTick: 720, idleEnergyPerTick: 24, exchangeEnergyPerTick: 0, isPowerConsumer: true, isPowerExchanger: false }],
    
    // Research machines
    [2901, { id: 2901, name: 'Matrix Lab', Type: 'Research', count: 0, isRaw: false, assemblerSpeed: 1, workEnergyPerTick: 480, idleEnergyPerTick: 16, exchangeEnergyPerTick: 0, isPowerConsumer: true, isPowerExchanger: false }],
    [2902, { id: 2902, name: 'Self-evolution Lab', Type: 'Research', count: 0, isRaw: false, assemblerSpeed: 3, workEnergyPerTick: 1440, idleEnergyPerTick: 48, exchangeEnergyPerTick: 0, isPowerConsumer: true, isPowerExchanger: false }],
    
    // Refine machines
    [2308, { id: 2308, name: 'Oil Refinery', Type: 'Refine', count: 0, isRaw: false, assemblerSpeed: 1, workEnergyPerTick: 480, idleEnergyPerTick: 16, exchangeEnergyPerTick: 0, isPowerConsumer: true, isPowerExchanger: false }],
    
    // Particle machines
    [2310, { id: 2310, name: 'Miniature Particle Collider', Type: 'Particle', count: 0, isRaw: false, assemblerSpeed: 1, workEnergyPerTick: 12000, idleEnergyPerTick: 400, exchangeEnergyPerTick: 0, isPowerConsumer: true, isPowerExchanger: false }],
  ]);
  ...
  describe('getMachineForRecipe', () => {
    ...
    describe('エラーハンドリング', () => {
      ...
      it('未定義のrecipeTypeの場合も処理できる（フォールバック）', () => {
        ...
        const machine = getMachineForRecipe('UnknownType' as Recipe['Type'], mockMachines, settings);
